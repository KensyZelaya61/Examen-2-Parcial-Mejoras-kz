#include <iostream>     // Kensy Michell Zelaya Hernandez
#include <string>       // Numero de cuenta: 20251001577
#include <cmath>        
#include <fstream>    
#include <iomanip>     
...
int main() {
    ...
    do {
        ...
        double productosCompradosDcto[NUM_PRODUCTOS] = {0.0};
        ...
        do {
            ...
            if (inventario[idx] == 0) {
                ...
                productosCompradosDcto[totalItemsDistintos] = totalDescuentoItem;
            ...
            cout << "Desea comprar otro producto para este cliente? (S/N): ";
        ...
        if (puntosClienteFactura >= 100) {
            ...
            cout << "\nDesea aplicar canje de puntos por dinero? (S/N): ";
            char opcionCanje;
            cin >> opcionCanje;
            if (opcionCanje == 'S' || opcionCanje == 's') {
        ...
        cout << "Presione ENTER para generar la factura...";
        cin.ignore();
        cin.get();
    ...
    } while (continuarCliente == 'S' || continuarCliente == 's');

    // Estadisticas finales
    int idxMasVendido = 0, idxMenosVendido = 0;
    ...
    for (int i = 1; i < NUM_PRODUCTOS; i++) {
        ...
        if (unidadesVendidas[i] < unidadesVendidas[idxMenosVendido]) idxMenosVendido = i;
    ...
    // Exportacion
    char respuestaDescarga;
    cout << "\nDesea guardar el reporte del dia en un archivo de texto? (S/N): ";
    cin >> respuestaDescarga;
    
    if (respuestaDescarga == 'S' || respuestaDescarga == 's') {
